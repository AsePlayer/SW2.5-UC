package de.polygonal.ds
{
          ...
          public class SLL implements Collection
          {
                    ...
                    {
                              var _loc3_:* = null as SLLNode;
                              var _loc2_:SLLNode = _reservedSize == 0 || _poolSize == 0 ? new SLLNode(param1,this) : (null, _loc3_ = _headPool, _headPool = _headPool.next, _poolSize = _poolSize - 1, _loc3_.val = param1, _loc3_.next = null, _loc3_);
                              if(tail != null)
                              {
                                        _loc2_.next = head;
                                        head = _loc2_;
                    ...
                    public function insertBefore(param1:SLLNode, param2:Object) : SLLNode
                    {
                              ...
                              null;
                              null;
                              var _loc3_:SLLNode = _reservedSize == 0 || _poolSize == 0 ? new SLLNode(param2,this) : (null, _loc4_ = _headPool, _headPool = _headPool.next, _poolSize = _poolSize - 1, _loc4_.val = param2, _loc4_.next = null, _loc4_);
                              if(param1 == head)
                              {
                                        _loc3_.next = head;
                                        head = _loc3_;

package de.polygonal.ds
{
          ...
          public class DLL implements Collection
          {
                    ...
                    public function shuffle(param1:DA = undefined) : void
                    {
                              ...
                              else
                              {
                                        ...
                                        while(_loc2_ > 1)
                                        {
                                                  _loc2_--;
                                                  null;
                                                  _loc6_ = int(param1._a[_loc4_++] * _loc2_);
                                                  _loc5_ = head;
                                                  _loc7_ = 0;
                                                  while(_loc7_ < _loc2_)
                                                  {
                    ...
                    {
                              var _loc3_:* = null as DLLNode;
                              var _loc2_:DLLNode = _reservedSize == 0 || _poolSize == 0 ? new DLLNode(param1,this) : (_loc3_ = _headPool, null, null, _headPool = _headPool.next, _poolSize = _poolSize - 1, _loc3_.next = null, _loc3_.val = param1, _loc3_);
                              _loc2_.next = head;
                              if(head != null)
                              {
                                        head.prev = _loc2_;
                    ...
                    public function insertBefore(param1:DLLNode, param2:Object) : DLLNode
                    {
                              ...
                              null;
                              null;
                              var _loc3_:DLLNode = _reservedSize == 0 || _poolSize == 0 ? new DLLNode(param2,this) : (_loc4_ = _headPool, null, null, _headPool = _headPool.next, _poolSize = _poolSize - 1, _loc4_.next = null, _loc4_.val = param2, _loc4_);
